...
%             if id > 2
%                 dlmwrite(strcat("AOA_signal/2/exp3_t", int2str(r), "_u", int2str(id), "_top.txt"), rx2);
%                 dlmwrite(strcat("AOA_signal/2/exp3_t", int2str(r), "_u", int2str(id), "_bottom.txt"), rx3);
%             end
%             user_sig1 = rx_signal(corr_idx - bias + Ns2+1 + GI - (Ns+GI) : corr_idx - bias + Ns2+tap_num + GI- (Ns+GI));
